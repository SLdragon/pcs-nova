...
const Config = {
  serviceUrls: {
    config: `https://novapcsconfig.azurewebsites.net/v1/`,
    iotHubManager: `https://novaiothubmanager.azurewebsites.net/v1/`,
    telemetry: `https://novatelemtry.azurewebsites.net/v1/`,
    //telemetry:'http://localhost:9004/v1/',
    deviceSimulation: `https://novadevicesimulator.azurewebsites.net/v1/`,
